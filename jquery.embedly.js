  ...
  $.extend({
    embedly: function(urls, options, callback){
      ...
      $.each(urls, function(i, v){
        ...
        if(typeof node != "undefined" && !(urlValid(v) || settings.key)){ $(node).data('oembed', false); }
